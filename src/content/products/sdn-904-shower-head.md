...
specs:
  ...
  type: "Square overhead shower"
  features:
    - "12-inch and 16-inch sizes"
    - "Silicone nozzles (anti-limescale)"
...
| Parameter | SDN-904 | SDN-905 |
|---|---|---|
| Size | 12 inches (300mm) | 16 inches (400mm) |
| Material | 304 Stainless Steel face, ABS body | 304 Stainless Steel face, ABS body |
| Finish | Chrome / Matte Black | Chrome / Matte Black |
| Nozzles | Silicone (easy-clean) | Silicone (easy-clean) |
| Connection | G1/2" ball joint | G1/2" ball joint |
| Spray Pattern | Rainfall | Rainfall |

### Features

- **Rainfall Coverage** — wide, even water distribution for a luxurious shower experience
- **Anti-Limescale Nozzles** — silicone tips wipe clean easily
- **Swivel Joint** — adjustable angle for different shower configurations
- **Corrosion-Resistant** — 304 stainless steel face plate with durable finish

### Packaging

- Individual box with foam padding
- Master carton: 20 pcs (12"), 12 pcs (16")
